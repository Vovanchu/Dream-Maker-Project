const uk = {
  ...
  feedback: {
    ...
    info: {
      ...
      confirmEmail: "Ми надіслали лист підтвердження на",
  ...
  pages: {
    ...
    googleAuth: {
      title: "Аутентифікація через Google",
      description:
        "Цей функціонал наразі перебуває в розробці. Незабаром ви зможете входити до системи за допомогою свого Google акаунта.",
      progress:
