const en = {
  ...
  modal: {
    ...
    thanksDesc:
      "Your donation has been accepted. We will notify you about the result.",
    close: "Close",
    collected: "Collected",
    of: "of",
    remaining: "Remaining to collect",
    donationLabel: "Donation amount (UAH)",
    donationPlaceholder: "Enter amount",
  ...
  addDream: {
    ...
    successTitle: "Dream submitted successfully!",
    successDesc:
    ...
    personNamePlaceholder: "E.g., Olenka",
    ageLabel: "Age *",
    ...
    dreamTitlePlaceholder: "Short dream title",
    dreamDescLabel: "Detailed description *",
    dreamDescPlaceholder: "Tell us more about the dream and why it matters...",
  ...
  reset: {
    ...
    successDesc: "We sent password reset instructions to",
    checkEmail: "Check your inbox.",
